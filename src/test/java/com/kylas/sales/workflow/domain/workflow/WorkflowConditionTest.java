...
class WorkflowConditionTest {
  ...
  public void givenEquals_onSameStrings_evaluatesTrue() {
    ...
    condition.setExpression(new ConditionExpression(EQUAL, "firstName", "Steve"));
  ...
  public void givenEquals_onDifferentStrings_evaluatesFalse() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    condition.setExpression(new ConditionExpression(EQUAL, "firstName", "Tony"));
    var entity = stubLeadDetail();
    entity.setFirstName("Steve");
  ...
  public void givenNotEquals_onDifferentStrings_evaluatesTrue() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    condition.setExpression(new ConditionExpression(Operator.NOT_EQUAL, "firstName", "Tony"));
    var entity = stubLeadDetail();
    entity.setFirstName("Steve");
    assertThat(condition.isSatisfiedBy(entity)).isTrue();
  }
  ...
  public void givenEquals_onSameBooleans_evaluatesTrue() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    condition.setExpression(new ConditionExpression(EQUAL, "dnd", "true"));
    var entity = stubLeadDetail();
    entity.setDnd(true);
    assertThat(condition.isSatisfiedBy(entity)).isTrue();
  }
  ...
  public void givenEquals_onDifferentBooleans_evaluatesFalse() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    condition.setExpression(new ConditionExpression(EQUAL, "dnd", "false"));
    var entity = stubLeadDetail();
    entity.setDnd(true);
    assertThat(condition.isSatisfiedBy(entity)).isFalse();
  }
  ...
  public void givenIsNullOperator_onNullValue_evaluatesTrue() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    condition.setExpression(new ConditionExpression(Operator.IS_NULL, "campaign", null));
    var entity = stubLeadDetail();
  ...
  public void givenContainsOperator_onMatchingValue_evaluatesTrue() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    condition.setExpression(new ConditionExpression(Operator.CONTAIN, "firstName", "eve"));
    var entity = stubLeadDetail();
    entity.setFirstName("Steve");
    assertThat(condition.isSatisfiedBy(entity)).isTrue();
  }
  ...
  public void givenGreaterThanOperator_onGreaterValue_evaluatesTrue() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    condition.setExpression(new ConditionExpression(GREATER, "companyAnnualRevenue", 900));
    var entity = stubLeadDetail();
  ...
  public void givenLessThanOperator_onLesserValue_evaluatesTrue() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    condition.setExpression(new ConditionExpression(LESS, "companyAnnualRevenue", 900));
    var entity = stubLeadDetail();
  ...
  public void givenAndOperator_withBothExpressionsTrue_evaluatesTrue() {
    var condition = new WorkflowCondition();
    condition.setType(ConditionType.CONDITION_BASED);
    var operand1 = new ConditionExpression(EQUAL, "firstName", "Tony");
    var operand2 = new ConditionExpression(EQUAL, "lastName", "Stark");
    condition.setExpression(new ConditionExpression(operand1, operand2, AND));
  ...
  public void givenOrOperator_onlyOneEvaluatingTrue_evaluatesTrue() {
    ...
    var operand1 = new ConditionExpression(EQUAL, "firstName", "Tony");
    var operand2 = new ConditionExpression(EQUAL, "lastName", "Stark");
    condition.setExpression(new ConditionExpression(operand1, operand2, OR));
