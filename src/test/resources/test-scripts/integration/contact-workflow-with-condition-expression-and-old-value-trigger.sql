...
(301, 'Workflow 1', 'Workflow 1', 'CONTACT',55, 12, now(), 12, now()),
(302, 'Workflow 1', 'Workflow 9', 'CONTACT',55, 12, now(), 12, now()),
...
OVERRIDING SYSTEM VALUE VALUES
(201, 'CONDITION_BASED','{"name": "firstName", "value": "Tony", "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"OLD_VALUE"}', 301),
(202, 'CONDITION_BASED','{"name": "firstName", "value": "Steve", "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"OLD_VALUE"}', 302),
