...
(202, 'CONDITION_BASED',
'{"operator": "AND","operand1": {"name": "firstName", "triggerOn":"OLD_VALUE","operator":"equal", "value": "Steve"},"operand2": {"name": "lastName","triggerOn":"OLD_VALUE", "operator":"equal", "value":"Roger"}}',
302),
