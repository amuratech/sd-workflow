...
OVERRIDING SYSTEM VALUE VALUES
(201, 'CONDITION_BASED','{"name": "name", "value": null, "operand1": null, "operand2": null, "operator": null, "triggerOn":"IS_CHANGED"}', 301),

(202, 'CONDITION_BASED',
'{"operator": "AND","operand1": {"name": "name", "triggerOn":"IS_CHANGED","operator":null, "value": null},"operand2": {"name": "product","triggerOn":"IS_CHANGED", "operator":null, "value":null } }',
302),
(203, 'FOR_ALL', null, 303),
(204, 'CONDITION_BASED','{"name": "ownedBy", "value": null, "operand1": null, "operand2": null, "operator": null, "triggerOn":"IS_CHANGED"}', 301),
(205, 'CONDITION_BASED','{"name": "pipeline", "value": null, "operand1": null, "operand2": null, "operator": null, "triggerOn":"IS_CHANGED"}', 301),
(206, 'CONDITION_BASED','{"name": "associatedContacts", "value": null, "operand1": null, "operand2": null, "operator": null, "triggerOn":"IS_CHANGED"}', 301),
(208, 'CONDITION_BASED','{"name": "estimatedValue", "value": null, "operand1": null, "operand2": null, "operator": null, "triggerOn":"IS_CHANGED"}', 301),
(209, 'CONDITION_BASED','{"name": "actualValue", "value": null, "operand1": null, "operand2": null, "operator": null, "triggerOn":"IS_CHANGED"}', 301);
