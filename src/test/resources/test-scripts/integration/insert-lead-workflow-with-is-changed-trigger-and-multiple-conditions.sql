...
OVERRIDING SYSTEM VALUE VALUES
(201, 'CONDITION_BASED','{"name": "firstName", "value": "Tony", "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"IS_CHANGED"}', 301),

(202, 'CONDITION_BASED',
'{"operator": "AND","operand1": {"name": "firstName", "triggerOn":"IS_CHANGED","operator":"equal", "value": "Steve"},"operand2": {"name": "lastName","triggerOn":"IS_CHANGED", "operator":"equal", "value":"Roger"}}',
302),
