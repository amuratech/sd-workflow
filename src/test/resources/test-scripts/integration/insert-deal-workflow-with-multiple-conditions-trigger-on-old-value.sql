...
OVERRIDING SYSTEM VALUE VALUES
(201, 'CONDITION_BASED','{"name": "name", "value": "new deal", "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"OLD_VALUE"}', 301),

(202, 'CONDITION_BASED',
'{"operator": "AND","operand1": {"name": "name", "triggerOn":"OLD_VALUE","operator":"equal", "value": "new deal"},"operand2": {"name": "product","triggerOn":"OLD_VALUE", "operator":"equal", "value":{"id" : 2, "name": "CRM"} } }',
302),
(203, 'FOR_ALL', null, 303),
(204, 'CONDITION_BASED','{"name": "ownedBy", "value": {"id": 5, "name": "newOwnedBy"}, "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"OLD_VALUE"}', 301),
(205, 'CONDITION_BASED','{"name": "pipeline", "value": {"id": 5, "name": "new pipeline", "stage": {"id" : 1, "name": "Open"}}, "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"OLD_VALUE"}', 301),
(206, 'CONDITION_BASED','{"name": "associatedContacts", "value": {"id": 6, "name": "new user"}, "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"OLD_VALUE"}', 301),
(208, 'CONDITION_BASED','{"name": "estimatedValue", "value": 50, "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"OLD_VALUE"}', 301),
(209, 'CONDITION_BASED','{"name": "actualValue", "value": 60, "operand1": null, "operand2": null, "operator": "EQUAL", "triggerOn":"OLD_VALUE"}', 301);
